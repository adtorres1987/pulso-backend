...
import { UpdateInvestmentProfileDto } from '../dtos/InvestmentProfileDto';

export class UpdateInvestmentProfileUseCase {
  constructor(private readonly investmentProfileRepository: IInvestmentProfileRepository) {}

  async execute(id: string, userId: string, dto: UpdateInvestmentProfileDto): Promise<InvestmentProfileResult> {
    ...
    return this.investmentProfileRepository.update(id, dto);
  }
}
